...
wget https://raw.githubusercontent.com/tnan/cyberpanel/master/spamassassin/local.cf -O /etc/mail/spamassassin/local.cf
wget https://raw.githubusercontent.com/tnan/cyberpanel/master/postfix/master.cf -O /etc/postfix/master.cf
groupadd spamd
...
wget https://raw.githubusercontent.com/tnan/cyberpanel/master/lsws/lsphp53/php.ini -O /usr/local/lsws/lsphp53/etc/php.ini
wget https://raw.githubusercontent.com/tnan/cyberpanel/master/lsws/lsphp54/php.ini -O /usr/local/lsws/lsphp54/etc/php.ini
wget https://raw.githubusercontent.com/tnan/cyberpanel/master/lsws/lsphp55/php.ini -O /usr/local/lsws/lsphp55/etc/php.ini
wget https://raw.githubusercontent.com/tnan/cyberpanel/master/lsws/lsphp56/php.ini -O /usr/local/lsws/lsphp56/etc/php.ini
wget https://raw.githubusercontent.com/tnan/cyberpanel/master/lsws/lsphp70/php.ini -O /usr/local/lsws/lsphp70/etc/php.ini
wget https://raw.githubusercontent.com/tnan/cyberpanel/master/lsws/lsphp71/php.ini -O /usr/local/lsws/lsphp71/etc/php.ini
wget https://raw.githubusercontent.com/tnan/cyberpanel/master/lsws/lsphp72/php.ini -O /usr/local/lsws/lsphp72/etc/php.ini
wget https://raw.githubusercontent.com/tnan/cyberpanel/master/lsws/lsphp73/php.ini -O /usr/local/lsws/lsphp73/etc/php.ini
wget https://raw.githubusercontent.com/tnan/cyberpanel/master/lsws/lsphp74/php.ini -O /usr/local/lsws/lsphp74/etc/php.ini
